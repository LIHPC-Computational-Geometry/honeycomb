...
// TODO: use cli args
pub fn bench_delaunay<T: CoordsFloat>(len_x: T, len_y: T, len_z: T, n_points: usize) -> CMap3<T> {
    ...
    points.into_iter().for_each(|p| {
        while let Err(e) = atomically_with_err(|t| {
            ...
            match e {
                DelaunayError::CavityBuilding(_) | DelaunayError::CircumsphereSingularity => break,
            }
        }
    });
