...
pub const NULL_VERTEX_ID: DartIdentifier = 0;
...
pub const NULL_EDGE_ID: DartIdentifier = 0;
...
pub const NULL_FACE_ID: DartIdentifier = 0;
...
pub const NULL_VOLUME_ID: DartIdentifier = 0;
